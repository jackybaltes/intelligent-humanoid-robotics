...
Your group can do the assignment using an Engineering Kit 2, OP-2, or OP-3
humanoid robot available in the ERC lab.
You can also decide to build your own robot leg.
